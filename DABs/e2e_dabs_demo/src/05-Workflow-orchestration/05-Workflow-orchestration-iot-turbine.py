...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F05-Workflow-orchestration%2F05-Workflow-orchestration-iot-turbine&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F05-Workflow-orchestration%2F05-Workflow-orchestration-iot-turbine&version=1">
...
# MAGIC %md
# MAGIC A workflow was created as part of this demo. Open the <a dbdemos-workflow-id="init-job" href="#job/526534057149809/tasks" target="_blank">IOT Wind Turbine Workflow</a> to start exploring Databricks orchestration capabilities!
