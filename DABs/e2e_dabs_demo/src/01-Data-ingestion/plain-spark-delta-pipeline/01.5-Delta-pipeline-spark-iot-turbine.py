...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-iot-platform-landan_george` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/1031-191319-w1e83hti/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-iot-turbine&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-iot-turbine&version=1">
...
# MAGIC %sql LIST '/Volumes/lgeorge/demos/turbine_raw_landing/incoming_data'

# COMMAND ----------

# DBTITLE 1,Review the raw sensor data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM PARQUET.`/Volumes/lgeorge/demos/turbine_raw_landing/incoming_data`
...
#                                                                 Model name         |        
#                                                                     |              |        
predict_maintenance = mlflow.pyfunc.spark_udf(spark, "models:/lgeorge.demos.dbdemos_turbine_maintenance@prod", "string") #, env_manager='virtualenv'
