...
GRANT SELECT ON TABLE lgeorge.demos.turbine TO `analysts`;
GRANT SELECT ON TABLE lgeorge.demos.sensor_bronze TO `analysts`;
GRANT SELECT ON TABLE lgeorge.demos.sensor_hourly TO `analysts`;
GRANT SELECT ON TABLE lgeorge.demos.historical_turbine_status TO `analysts`;

-- We'll grant an extra MODIFY to our Data Engineer
GRANT SELECT, MODIFY ON SCHEMA lgeorge.demos TO `dataengineers`;
